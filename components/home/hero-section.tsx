    ...
    <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
      <div className="flex">
        <div className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-blue-200 via-blue-500 to-blue-800 animate-gradient-x group">
          <Badge
            variant={"secondary"}
            className="relative px-6 py-2 text-base font-medium bg-white rounded-full group-hover:bg-gray-200 transition-colors duration-200"
          >
            <Sparkles className="text-base text-blue-600 animate-pulse" />
      ...
      <h1 className="text-center py-6 font-bold">
        ...
        <span className="relative inline-block">
          ...
          <span
            className="absolute inset-0 bg-blue-200/50 rounded-lg transform -skew-y-1"
            area-hidden="true"
          ></span>
        </span>
        summaries
      ...
      <div>
        <Button
          ...
          className="text-white mt-6 text-base sm:text-lg lg:text-xl rounded-full px-8 sm:px-10 lg:px-12 py-6 sm:py-7 lg:py-8 lg:mt-16
            bg-linear-to-r from-slate-900 to to-blue-500 hover:from-blue-500 hover:to-slate-900 hover:no-underline font-bold
            shadow-lg transition-all duration-300
          "
        >
          <Link href="/#pricing" className="flex items-center gap-2 text-white">
            <span>Try SummarAIze</span>
